...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://sequoia-condition-164.notion.site/4d873c63e7344ea393b64108ddc8adfe?v=b7f5c09732b44794bf40d7a6f91e3eb3&pvs=4
  NOTION_PAGE_ID:
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi! I am a master student from Beijing Normal University(China). Welcome to my blog! 🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xuan Lin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Never Settle, Never Still', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xuanlin.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog, Xuan, Lin', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'linxuan@mail.bnu.edu.cn', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_TEL: process.env.NEXT_PUBLIC_CONTACT_TEL || '+86 13366206503', // 你的电话
  CONTACT_WECHAT: process.env.NEXT_PUBLIC_CONTACT_WECHAT || '', // 你的微信
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Lindsay-03/', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  //   ********挂件组件相关********
  // Chatbase
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'Thq3iaq5ZKKxVwODY1wWJ', // 是否显示chatbase机器人 https://www.chatbase.co/ ,
