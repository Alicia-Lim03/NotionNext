...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi! I am Xuan Lin, I am a master student from Beijing Normal University(China). Welcome to my blog! 🎉',
  ...
  CONTACT_WECHAT: process.env.NEXT_PUBLIC_CONTACT_WECHAT || 'limmy03', // 你的微信
